...
public class UI_DeliveryStaffProfile extends JPanel {
    JButton backBtn;
    JLabel profilePic;
    JLabel name;
    JLabel idHeader;
    ...
    public UI_DeliveryStaffProfile(){
        User user = OODMS_Main.current_user;
        DeliveryStaff DeliveryStaff = (DeliveryStaff) OODMS_Main.current_user;
        user = DeliveryStaffService.getDeliveryStaffService().getStaff(DeliveryStaff.getID());
        ...
        editProfile.addActionListener(e -> {
            ...
            OODMS_Main.frame.replacePanel(new UI_DeliveryStaffProfileEdit(DeliveryStaff.getID()));
        });
